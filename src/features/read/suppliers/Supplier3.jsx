...
import Alpina from "@/assets/images/suppliers/alpina.png";
import { useNavigate } from "react-router-dom";

export default function ReadSupplier() {
  const supplier = {
    companyName: "Alpina",
    supplierImage: Alpina,
    documentType: "NIT",
    documentNumber: "860025900",
    supplierEmail: "alpinaExpss@email.com",
    supplierPhone: "+57 311 123 5678",
    supplierAddress: "Diagonal 25a DB",
    productTypes: ["Lacteos", "Bebidas"],
    status: "Activo",
  };
