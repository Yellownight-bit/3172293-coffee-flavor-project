...
import Nestle from "@/assets/images/suppliers/nestle.png";
import { useNavigate } from "react-router-dom";

export default function ReadSupplier() {
  const supplier = {
    companyName: "Nestle Colombia",
    supplierImage: Nestle,
    documentType: "NIT",
    documentNumber: "860002130",
    supplierEmail: "nestleExpss@email.com",
    supplierPhone: "+57 311 123 5678",
    supplierAddress: "Diagonal 25a DB",
    productTypes: ["Café", "Procesantes"],
    status: "Activo",
  };
