...
import Maycol from "@/assets/images/users/maycol.png";
...
export default function ReadUser() {
  const user = {
    ...
    documentNumber: "1089088940",
    userType: "Cajero",
    userEmail: "maysilva@example.com",
    institutionalEmail: "maycol.silva@sena.edu.co",
    userPhone: "3204561234",
    secondPhone: "3209876541",
    address: "La Virginia, Risaralda",
